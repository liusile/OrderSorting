...
{
    partial class frmOrderSortingWork
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.CheckGratingTimer = new System.Windows.Forms.Timer(this.components);
            this.CheckButtonTimer = new System.Windows.Forms.Timer(this.components);
            this.CheckBlockTimer = new System.Windows.Forms.Timer(this.components);
            this.CheckUnblockTimer = new System.Windows.Forms.Timer(this.components);
            ...
            this.txtOrderId.Size = new System.Drawing.Size(293, 34);
            ...
            this.lblOrderId.Font = new System.Drawing.Font("微软雅黑", 13F, System.Drawing.FontStyle.Bold);
            this.lblOrderId.ForeColor = System.Drawing.Color.Red;
            this.lblOrderId.Location = new System.Drawing.Point(430, 44);
            this.lblOrderId.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.lblOrderId.Name = "lblOrderId";
            this.lblOrderId.Size = new System.Drawing.Size(101, 30);
            this.lblOrderId.TabIndex = 5;
            this.lblOrderId.Text = "停止分拣";
            // 
            // CheckGratingTimer
            // 
            this.CheckGratingTimer.Interval = 224;
            this.CheckGratingTimer.Tick += new System.EventHandler(this.CheckGratingTimer_Tick);
            // 
            // CheckButtonTimer
            // 
            this.CheckButtonTimer.Interval = 1025;
            this.CheckButtonTimer.Tick += new System.EventHandler(this.CheckButtonTimer_Tick);
            // 
            // CheckBlockTimer
            // 
            this.CheckBlockTimer.Interval = 377;
            this.CheckBlockTimer.Tick += new System.EventHandler(this.CheckBlockTimer_Tick);
            // 
            // CheckUnblockTimer
            // 
            this.CheckUnblockTimer.Interval = 769;
            this.CheckUnblockTimer.Tick += new System.EventHandler(this.CheckUnblockTimer_Tick);
            // 
            // menuStrip1
            // 
            ...
            this.lblMsg.Location = new System.Drawing.Point(613, 44);
            ...
            this.Name = "frmOrderSortingWork";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "分拣架作业";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.frmOrderSortingWork_FormClosing);
        ...
        private System.Windows.Forms.Timer CheckGratingTimer;
        private System.Windows.Forms.Timer CheckButtonTimer;
        private System.Windows.Forms.Timer CheckBlockTimer;
        private System.Windows.Forms.Timer CheckUnblockTimer;
